...
.state('searchPo', {		
        ...
        .state('queryPO', {
            url: "/queryPO",
            templateUrl: "views/queryPO.html",
            data: {pageTitle: '採購單檢索系統', pageSubTitle: ''},
            controller: "queryPOCtrl",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: 'app',
    ...
    .state('reportFactory', {
        ...
        .state('vansaleManagement', {
            url: "/vansaleManagement",
            templateUrl: "views/vansaleManagement.html",
            data: {pageTitle: '預載單', pageSubTitle: ''},
            controller: "vansaleManagementCtrl",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: 'app',
                        insertBefore: '#ng_load_plugins_before', // load the above css files before '#ng_load_plugins_before'
                        files: [
                            'js/controllers/vansaleManagementCtrl.js',
                            assets + '/global/plugins/bootbox/bootbox.min.js',
                            assets + '/global/plugins/bootstrap-datepicker/css/datepicker3.css',
                            assets + '/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js',
                        ]
        ...
        .state('dailySalesSummary', {
            url: "/dailySalesSummary",
            templateUrl: "views/financialReport/dailySalesSummary.html",
            data: {pageTitle: '列印記錄', pageSubTitle: ''},
            controller: "dailySalesSummaryCtrl",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: 'app',
                        insertBefore: '#ng_load_plugins_before', // load the above css files before '#ng_load_plugins_before'
                        files: [
                            'js/controllers/financialReport/dailySalesSummaryCtrl.js',
                            assets + '/global/plugins/bootbox/bootbox.min.js',
        ...
        .state('agingByZoneCash', {
            url: "/agingByZoneCash",
            templateUrl: "views/financialReport/agingByZoneCash.html",
            data: {pageTitle: '列印記錄', pageSubTitle: ''},
            controller: "agingByZoneCashCtrl",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: 'app',
        ...
        .state('yearEndReport', {
            url: "/yearEndReport",
            templateUrl: "views/financialReport/yearEndReport.html",
            data: {pageTitle: '列印記錄', pageSubTitle: ''},
            controller: "yearEndReportCtrl",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: 'app',
